        ...
        /*01d0*/                   LDSM.16.M88.4 R4, [R3+0x400] ;
        /*01e0*/                   LDSM.16.MT88.4 R8, [R3+0x200] ;
        /*01f0*/                   HMMA.16816.F16 R8, R4, R8, R12 ;
        /*0200*/                   NOP ;
        /*0210*/                   HMMA.16816.F16 R10, R4, R10, R14 ;
        /*0220*/                   NOP ;
        /*0230*/                   NOP ;
        /*0240*/                   MOVM.16.MT88 R5, R8 ;
        /*0250*/                   LOP3.LUT R0, R16.reuse, 0xfffffffc, RZ, 0xc0, !PT ;
        /*0260*/                   ULDC.64 UR4, c[0x0][0x30] ;
        /*0270*/                   LOP3.LUT R1, R16, 0x3, RZ, 0xc0, !PT ;
