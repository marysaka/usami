        ...
        /*01a0*/                   NOP ;
        /*01b0*/                   NOP ;
        /*01c0*/                   LDSM.16.MT88.4 R4, [R4+0x400] ;
        /*01d0*/                   LOP3.LUT R0, R16.reuse, 0xfffffffc, RZ, 0xc0, !PT ;
        /*01e0*/                   LOP3.LUT R1, R16, 0x3, RZ, 0xc0, !PT ;
        /*01f0*/                   LDSM.16.MT88.4 R8, [R3+0x200] ;
        /*0200*/                   IMAD R1, R1, 0x4, R0 ;
        /*0210*/                   IADD3 R0, R1.reuse, 0x20, RZ ;
        /*0220*/                   LDSM.16.M88.4 R12, [R3] ;
        /*0230*/                   IADD3 R2, R1, 0x30, RZ ;
        /*0240*/                   HMMA.16816.F16 R8, R4, R8, R12 ;
        /*0250*/                   NOP ;
        /*0260*/                   HMMA.16816.F16 R10, R4, R10, R14 ;
        /*0270*/                   IADD3 R5, R1, 0x10, RZ ;
        /*0280*/                   NOP ;
        /*0290*/                   NOP ;
