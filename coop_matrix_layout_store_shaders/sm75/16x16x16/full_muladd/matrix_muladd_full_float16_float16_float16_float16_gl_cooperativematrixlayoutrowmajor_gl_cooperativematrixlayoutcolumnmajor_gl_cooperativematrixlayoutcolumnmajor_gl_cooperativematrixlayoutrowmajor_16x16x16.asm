        ...
        /*0100*/                   LOP3.LUT R4, R7, 0x10, RZ, 0xc0, !PT ;
        /*0110*/                   LEA.HI R5, R4, R3, RZ, 0x1f ;
        /*0120*/                   LOP3.LUT R3, R7, 0xf, RZ, 0xc0, !PT ;
        /*0130*/                   LOP3.LUT R6, R5.reuse, 0xf, RZ, 0xc0, !PT ;
        /*0140*/                   LOP3.LUT R5, R5, 0x10, RZ, 0xc0, !PT ;
        /*0150*/                   IMAD R3, R3, 0x4, R4 ;
        /*0160*/                   IMAD R5, R6, 0x4, R5 ;
        /*0170*/                   STS.U16 [0x400], R8 ;
        /*0180*/                   STS.U16 [0x200], R1 ;
        /*0190*/                   STS.U16 [RZ], R2 ;
        /*01a0*/                   NOP ;
        /*01b0*/                   NOP ;
        /*01c0*/                   LDSM.16.M88.4 R0, [R3+0x400] ;
        /*01d0*/                   LOP3.LUT R4, R7, 0xfffffffc, RZ, 0xc0, !PT ;
        /*01e0*/                   LDSM.16.M88.4 R8, [R5+0x200] ;
        /*01f0*/                   LDSM.16.MT88.4 R12, [R5] ;
        /*0200*/                   HMMA.16816.F16 R8, R0, R8, R12 ;
        /*0210*/                   NOP ;
        /*0220*/                   HMMA.16816.F16 R10, R0, R10, R14 ;
        /*0230*/                   LOP3.LUT R1, R7, 0x3, RZ, 0xc0, !PT ;
        /*0240*/                   IMAD R1, R1, 0x4, R4 ;
        /*0250*/                   IADD3 R0, R1.reuse, 0x20, RZ ;
        /*0260*/                   IADD3 R7, R1.reuse, 0x10, RZ ;
        /*0270*/                   IADD3 R2, R1, 0x30, RZ ;
        /*0280*/                   NOP ;
        /*0290*/                   NOP ;
        /*02a0*/                   ULDC.64 UR4, c[0x0][0x30] ;
        /*02b0*/                   STG.E.STRONG.CTA [R1.U32+UR4], R8 ;
        /*02c0*/                   STG.E.STRONG.CTA [R0.U32+UR4], R9 ;
        /*02d0*/                   STG.E.STRONG.CTA [R7.U32+UR4], R10 ;
