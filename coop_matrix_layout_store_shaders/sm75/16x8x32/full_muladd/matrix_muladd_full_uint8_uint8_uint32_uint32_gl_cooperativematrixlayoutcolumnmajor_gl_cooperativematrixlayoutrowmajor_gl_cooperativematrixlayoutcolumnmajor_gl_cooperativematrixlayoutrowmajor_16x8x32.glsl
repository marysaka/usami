// matrix_muladd_full_uint8_uint8_uint32_uint32_gl_cooperativematrixlayoutcolumnmajor_gl_cooperativematrixlayoutrowmajor_gl_cooperativematrixlayoutcolumnmajor_gl_cooperativematrixlayoutrowmajor_16x8x32.glsl
...
#define elementTypeA uint8_t
#define elementTypeB uint8_t
#define elementTypeC uint32_t
#define elementTypeD uint32_t
#define strideTypeA 1
#define strideTypeB 1
#define strideTypeC 4
#define strideTypeD 4
#define MATRIX_LAYOUT_MAJOR_A gl_CooperativeMatrixLayoutColumnMajor
#define MATRIX_LAYOUT_MAJOR_B gl_CooperativeMatrixLayoutRowMajor
#define MATRIX_LAYOUT_MAJOR_C gl_CooperativeMatrixLayoutColumnMajor
#define MATRIX_LAYOUT_MAJOR_D gl_CooperativeMatrixLayoutRowMajor
const int M = 16;
const int N = 8;
const int K = 32;
