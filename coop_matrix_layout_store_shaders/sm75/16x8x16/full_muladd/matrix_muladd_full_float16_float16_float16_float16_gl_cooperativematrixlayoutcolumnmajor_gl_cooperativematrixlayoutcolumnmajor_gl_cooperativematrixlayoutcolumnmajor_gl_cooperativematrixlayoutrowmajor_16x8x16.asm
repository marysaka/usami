        ...
        /*0210*/                   LOP3.LUT R0, R11.reuse, 0xfffffffc, RZ, 0xc0, !PT ;
        /*0220*/                   LOP3.LUT R1, R11, 0x3, RZ, 0xc0, !PT ;
        /*0230*/                   IMAD R1, R1, 0x4, R0 ;
        /*0240*/                   IADD3 R0, R1, 0x20, RZ ;
        /*0250*/                   NOP ;
        /*0260*/                   NOP ;
        /*0270*/                   ULDC.64 UR4, c[0x0][0x30] ;
        /*0280*/                   STG.E.STRONG.CTA [R1.U32+UR4], R6 ;
        /*0290*/                   STG.E.STRONG.CTA [R0.U32+UR4], R7 ;
        /*02a0*/                   EXIT ;
        /*02b0*/                   BRA 0x2b0;
        /*02c0*/                   NOP;
        /*02d0*/                   NOP;
