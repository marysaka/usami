        ...
        /*00d0*/                   LOP3.LUT R4, R7, 0x8, RZ, 0xc0, !PT ;
        /*00e0*/                   IMAD.SHL.U32 R4, R4, 0x2, RZ ;
        /*00f0*/                   LOP3.LUT R5, R7.reuse, 0x7, R4, 0xc8, !PT ;
        /*0100*/                   LOP3.LUT R4, R4, 0x10, RZ, 0xc0, !PT ;
        /*0110*/                   IMAD.SHL.U32 R6, R7, 0x4, RZ ;
        /*0120*/                   IMAD R4, R5, 0x4, R4 ;
        /*0130*/                   STS.U16 [0x180], R1 ;
        /*0140*/                   STS.U16 [0x100], R2 ;
        /*0150*/                   STS.U16 [RZ], R3 ;
        /*0160*/                   NOP ;
        /*0170*/                   NOP ;
        /*0180*/                   LDSM.16.MT88 R0, [R6+0x100] ;
        /*0190*/                   LDSM.16.MT88.2 R4, [R4+0x180] ;
        /*01a0*/                   LDSM.16.M88.2 R2, [R6] ;
        /*01b0*/                   HMMA.1688.F16 R2, R4, R0, R2 ;
        /*01c0*/                   NOP ;
        /*01d0*/                   NOP ;
        /*01e0*/                   MOVM.16.MT88 R5, R2 ;
        /*01f0*/                   LOP3.LUT R0, R7.reuse, 0xfffffffc, RZ, 0xc0, !PT ;
        /*0200*/                   ULDC.64 UR4, c[0x0][0x30] ;
        /*0210*/                   LOP3.LUT R1, R7, 0x3, RZ, 0xc0, !PT ;
        /*0220*/                   MOVM.16.MT88 R4, R3 ;
        /*0230*/                   IMAD R0, R1, 0x4, R0 ;
        /*0240*/                   IADD3 R1, R0, 0x10, RZ ;
        /*0250*/                   STG.E.STRONG.CTA [R0.U32+UR4], R5 ;
        /*0260*/                   STG.E.STRONG.CTA [R1.U32+UR4], R4 ;
        /*0270*/                   EXIT ;
        /*0280*/                   BRA 0x280;
        /*0290*/                   NOP;
        /*02a0*/                   NOP;
