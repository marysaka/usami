        ...
        /*0190*/                   LOP3.LUT R1, R7.reuse, 0xfffffffc, RZ, 0xc0, !PT ;
        /*01a0*/                   LOP3.LUT R8, R7, 0x3, RZ, 0xc0, !PT ;
        /*01b0*/                   LDSM.16.MT88.2 R4, [R4+0x180] ;
        /*01c0*/                   LDSM.16.M88.2 R2, [R6] ;
        /*01d0*/                   IMAD R1, R8, 0x4, R1 ;
        /*01e0*/                   HMMA.1688.F16 R2, R4, R0, R2 ;
        /*01f0*/                   IADD3 R0, R1, 0x20, RZ ;
        /*0200*/                   NOP ;
        /*0210*/                   NOP ;
        /*0220*/                   ULDC.64 UR4, c[0x0][0x30] ;
        /*0230*/                   STG.E.STRONG.CTA [R1.U32+UR4], R2 ;
        /*0240*/                   STG.E.STRONG.CTA [R0.U32+UR4], R3 ;
        /*0250*/                   EXIT ;
        /*0260*/                   BRA 0x260;
        /*0270*/                   NOP;
