// matrix_float32_use_c_16x16.glsl
...
#define elementType float32_t
#define MATRIX_LAYOUT_MAJOR gl_CooperativeMatrixLayoutRowMajor
#define MATRIX_USAGE gl_MatrixUseAccumulator
const int ROW = 16;
const int COL = 16;
