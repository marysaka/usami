        ...
        /*0040*/                   IMAD.MOV.U32 R4, RZ, RZ, 0x1 ;
        /*0050*/                   MOV R6, 0x3 ;
        /*0060*/                   IMAD.MOV.U32 R5, RZ, RZ, 0x2 ;
        /*0070*/                   IMAD.MOV.U32 R7, RZ, RZ, 0x4 ;
        /*0080*/                   @P1 IMAD.MOV.U32 R3, RZ, RZ, c[0x0][0x44] ;
        /*0090*/                   @P1 MOV R2, c[0x0][0x40] ;
        /*00a0*/                   @P0 IMAD.MOV.U32 R0, RZ, RZ, c[0x0][0x50] ;
        /*00b0*/                   @P0 MOV R1, c[0x0][0x54] ;
        /*00c0*/                   STL.128 [RZ], R4 ;
        /*00d0*/                   @P1 LDG.E.STRONG.SM R3, [R2] ;
        /*00e0*/                   @P0 LDG.E.STRONG.SM R8, [R0] ;
        /*00f0*/                   NOP ;
        /*0100*/                   NOP ;
        /*0110*/                   LDL.128 R4, [RZ] ;
        /*0120*/                   @!P1 IMAD.MOV.U32 R2, RZ, RZ, RZ ;
        /*0130*/                   @P1 SHF.L.U32 R2, R3, 0x2, RZ ;
        /*0140*/                   @!P0 CS2R R0, SRZ ;
        /*0150*/                   S2R R10, SR_LANEID ;
        ...
        /*0230*/                   STG.E.64.STRONG.SM [R0], R4 ;
        /*0240*/                   STG.E.64.STRONG.SM [R2], R6 ;
        /*0250*/                   EXIT ;
        /*0260*/                   BRA 0x260;
        /*0270*/                   NOP;
        /*0280*/                   NOP;
